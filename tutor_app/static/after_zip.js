...
function goToLessonScreen() {
    ...
    console.log("👀 showFields:", lessonState.showFields);
    console.log("📌 topicInput exists:", document.getElementById("lesson-topic") !== null);
    console.log("📌 locationInput exists:", document.getElementById("lesson-location") !== null);
